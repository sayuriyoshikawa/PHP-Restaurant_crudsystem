...
if ($_GET['id']) {
   ...
   $sql2 = "SELECT * FROM booking WHERE fk_userId = {$id}";
...
if ($_POST) {
   ...
   ($picture == "pictures/avatar.png") ?: unlink("pictures/$picture");

   $sql2 = "DELETE FROM booking WHERE fk_userId = {$id};";
...
<body>
   ...
   <fieldset>
      ...
      <h3 class="mb-4">Do you really want to delete this user?<br>
         If you delete this user, this user's reservation will be deleted, too.</h3>
      <form method="post">
